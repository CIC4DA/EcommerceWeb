          ...
          <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
              ...
              <div className="flex items-center">
                <Link to="/admin/product-form" className='bg-white mx-4 hover:bg-green-200 text-gray-800 font-semibold py-1 px-3 border border-gray-400 rounded'>
                  Add New Product
                </Link>
        ...
        <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
          {products.map((product) => (
            <div>
              ...
              <div className="flex justify-center border-solid border-2 border-gray-100 p-2">
                <Link to={`/admin/product-form/edit/${product.id}`}className='bg-white hover:bg-gray-200 text-gray-800 font-semibold py-1 px-3 border border-gray-400 rounded shadow'>Edit Product</Link>
              </div>
            </div>
          ))}
        </div>
          ...
          <nav className="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
            ...
            {Array.from({ length: totalpages }).map((e, index) => (
              <div
                ...
                aria-current="page"
                className={`relative z-10 inline-flex  px-4 py-2 text-sm cursor-pointer items-center
                      font-semibold focus:z-20 focus-visible:outline 
                       ${index + 1 === page ? 'bg-indigo-600 text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600' : 'text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:outline-offset-0'}`}
              >
                {index + 1}
              </div>
            ))}
