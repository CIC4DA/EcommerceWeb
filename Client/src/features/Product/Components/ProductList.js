    ...
    <>
      <div className="container bg-white mb-2">
        <div
          className="card"
          style={{
            backgroundImage: 'url(pexels-mnz-1598505.jpg)'
          }}
        />
        <div
          className="card"
          style={{
            backgroundImage: 'url(pexels-jd-danny-2385477.jpg)'
          }}
        />
        <div className="text-8xl font-bold text-white" style={{
          position: "absolute",
          top: "50%",
          left: "50%",
          transform: "translate(-50%, -50%)"
        }}>The style you love!</div>
