...
import { resetPasswordAsync, resetPasswordUserAsync} from '../Auth/authSlice';
        ...
        <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
          ...
          <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form noValidate className="space-y-6" onSubmit={handleSubmit((data) => {
              dispatch(resetPasswordUserAsync({email,token, newPassword : data.password, oldPassword : data.oldPassword}));
              reset();
              Navigate(-1);
            })}>
              <div>
                ...
                <div className="mt-2">
                  ...
                  />
                  <div className='text-red-500 text-xs'>{errors?.oldPassword?.message}</div>
                </div>
              </div>
              <div>
                <div className="flex items-center justify-between">
              ...
              <div>
                <button
                  type="submit"
                  onClick={e => (toast('New Password is Set', {
                    duration: 4000,
                    position: 'top-center',
